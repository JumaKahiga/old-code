...
if(isset($_POST['description']))
{
    ...
    $query=queryMysql("insert into csrTable (description,amount,date) values ('$description','$amount','$date')");
    if($query)
    {
                ...
                <div class="row">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Add CSR activity<small>  Record activity</small></h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-12 b-r"><h3 class="m-t-none m-b">Add Expense</h3>
                                                    ...
                                                    <form role="form" method="post" action="csr.php">
         ...
         while($row = $result->fetch_assoc())
            {
                ...
                echo "<tr class='gradeX'><td>".$row['description']."</td><td>".$row['amount']."</td><td>".$row['date']."</td></tr>";
